window.PRODUCTS = [
  {
    ...
    skus: [
      {name:"USB-HUB-4P-BLK", online:"AEO-1005009448608090-BLK", local:"SKU-USB-HUB-BLK", code:"050972", barcode:"697113956719", goodsId:"979113956719", spec:"黑色", status:"销售中", activity:true, price:"CNY 18.80", platform:30, localStock:8, warehouse:"CSC207", warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:10},{code:"CN-HZ-01",name:"杭州仓",stock:20}], binding:"绑定中", method:"本地可用库存"},
      {name:"USB-HUB-4P-WHT", online:"AEO-1005009448608090-WHT", local:"SKU-USB-HUB-WHT", code:"050973", barcode:"697113956720", goodsId:"979113956720", spec:"白色", status:"停售", activity:true, price:"CNY 22.50", platform:5, localStock:3, warehouse:"CSC207", warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:0},{code:"CN-HZ-01",name:"杭州仓",stock:5}], binding:"未绑定", method:"自定义数量"},
      {name:"USB-HUB-4P-GRY", online:"AEO-1005009448608090-GRY", local:"SKU-USB-HUB-GRY", code:"050974", barcode:"697113956721", goodsId:"979113956721", spec:"灰色", status:"销售中", activity:true, price:"CNY 20.00", platform:0, localStock:0, warehouse:"CSC207", warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:0},{code:"CN-HZ-01",name:"杭州仓",stock:0}], binding:"绑定中", method:"无库存兜底"}
    ]
  },
  {
  ...
  },
  {
    ...
    skus:[
      ...
      {name:"BUCK-600W-15A",online:"AEO-1005012097534664-15A",local:"SKU-BUCK-600W-15A",code:"070615",barcode:"697113957002",goodsId:"979113957002",spec:"15A",status:"停售",activity:false,price:"CNY 25.80",platform:0,localStock:0,warehouse:"CSC207",warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:0},{code:"CN-HZ-01",name:"杭州仓",stock:0}],binding:"未绑定",method:"无库存兜底"},
      {name:"BUCK-600W-20A",online:"AEO-1005012097534664-20A",local:"SKU-BUCK-600W-20A",code:"070620",barcode:"697113957003",goodsId:"979113957003",spec:"20A",status:"停售",activity:false,price:"CNY 27.80",platform:0,localStock:0,warehouse:"CSC207",warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:0},{code:"CN-HZ-01",name:"杭州仓",stock:0}],binding:"未绑定",method:"无库存兜底"},
      {name:"BUCK-600W-30A",online:"AEO-1005012097534664-30A",local:"SKU-BUCK-600W-30A",code:"070630",barcode:"697113957004",goodsId:"979113957004",spec:"30A",status:"停售",activity:false,price:"CNY 32.80",platform:0,localStock:0,warehouse:"CSC207",warehouses:[{code:"CN-DG-01",name:"东莞仓",stock:0},{code:"CN-HZ-01",name:"杭州仓",stock:0}],binding:"未绑定",method:"无库存兜底"}
    ]
  }
];
